...
public class Main extends JFrame {
	...
	public final static Object[] apps = {
		...
		new Object[] {
			...
			new AppDesc("step 1: no collision detection", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step1.BulletTest.class),
			new AppDesc("step 2: using a collision algorithm", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step2.BulletTest.class),
			new AppDesc("step 3: using a collision dispatcher", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step3.BulletTest.class),
			new AppDesc("step 4: add more objects", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step4.BulletTest.class),
			new AppDesc("step 5: using a ContactListener", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step5.BulletTest.class),
			new AppDesc("step 6: optimize the callback method", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step6.BulletTest.class),
			new AppDesc("step 7: using a collision world", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step7.BulletTest.class),
			new AppDesc("step 8: using collision filtering", false, 640, 480, com.xoppa.blog.libgdx.g3d.bullet.collision.step8.BulletTest.class)
		}
	};
